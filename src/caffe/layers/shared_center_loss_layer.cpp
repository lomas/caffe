...
void SharedCenterLossLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
  ...
  if (this->blobs_.size() > 0) {
    ...
    center_shape[0] = N_; //number of center
    center_shape[1] = K_; //center dims
